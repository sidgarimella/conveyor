...
class Pipeline:
    ...
    def add_notebook(self, filename, carry_vars, select_cells=None, start_cell_idx=None, until_variable=None):
        self.steps.append(
                NotebookStep(filename, carry_vars=carry_vars, 
                    start_cell_idx=start_cell_idx, select_cells=select_cells, until_variable=until_variable)
            )
